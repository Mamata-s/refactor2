...
if __name__ == "__main__":
    ...
    parser.add_argument('--config', help="configuration file *.yml", type=str, required=False, default='yaml/mask_hrdownsample/dense_z_axis25_mask_training_addition_f2.yaml')
