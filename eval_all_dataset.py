...
This file contains the code to plot psnr,nrmse,ssim and hfen boxplot for one checkpoint evaluted on all test sets.
...
def create_each_plot(initial,model,save_name="ssim",y_min=None,y_max=None, ticks=None):
    ...
    plt.ylabel(title+ ' Value',fontsize=25)
    # plt.xlabel('datasets')
    plt.tight_layout()
...
def plot_boxplot(initial_list, model_list):
    ...
    # ylim_max = [37.175, 0.99, 0.028, 0.4, 0.28]
...
if __name__ == '__main__':
    ...
    checkpoint1=[
       ...
       'outputs/dataset_images_srdense/bicubic_dataset25/srcnn/srcnn_bicubic_dataset25/checkpoints/z_axis/factor_2/epoch_500_f_2.pth',
    ...
    names = ['Gaussian', 'hanning_model', 'hamming_model', 'bicubic','mean','median', 'combine_fix']
