...
# checkpoint='outputs/resolution_dataset25_small4/srdense/edge_range_corr_dense_bottlenecksmall_hrdownsample_z_axis25_small4_no_mask_training_original_f4_105_0.0001/checkpoints/z_axis/factor_4/epoch_100_f_4.pth'
plot_dir= f'test_set/plots_{factor}/'
preds_dir=f'test_set/preds_{factor}/'
edge_type='downsample'
pred_edges_dir=f'test_set/preds_edges_{factor}/'
