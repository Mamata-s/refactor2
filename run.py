...
# ******* Get result of gaussian downsample edges with losstype original ie loss calculate on edges
# model_name= 'dense'
# factor=2
...
# os.system(f"python test.py --checkpoint={checkpoint} --model_name={model_name} --factor={factor} ")
